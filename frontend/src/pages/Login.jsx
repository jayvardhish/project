    ...
    return (
        <div className="min-h-screen flex bg-white font-body">
            ...
            <div className="hidden lg:flex w-1/2 purple-gradient p-12 flex-col justify-between text-white relative overflow-hidden">
                <div className="relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl text-purple-100 max-w-md">
                            Log in to access your personalized learning dashboard and continue your journey.
                        </p>
                    </motion.div>
                </div>
                ...
                <div className="absolute top-1/4 -right-20 w-80 h-80 bg-white opacity-10 rounded-full blur-3xl"></div>
                <div className="absolute bottom-1/4 -left-20 w-80 h-80 bg-white opacity-10 rounded-full blur-3xl"></div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-12">
                ...
                >
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div>
                            <div className="flex justify-between mb-2">
                                ...
                                <Link to="/forgot-password" title="Forgot Password" className="text-sm text-primary font-semibold hover:text-primary-light">Forgot?</Link>
                            </div>
                            <div className="relative">
                    ...
                    <div className="mt-8 relative">
                        <div className="absolute inset-0 flex items-center text-blue-100">
                    ...
                    <p className="mt-10 text-center text-gray-500">
                        Don't have an account? <Link to="/signup" className="text-primary font-bold hover:text-primary-light">Sign Up</Link>
                    </p>
                </motion.div>
            </div>
        </div>
